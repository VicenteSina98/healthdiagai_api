...
class AntecedentesMedicos(models.Model):
	enfermedades_cronicas = models.CharField(max_length=256, null=True)
	historial_alergias = models.CharField(max_length=256, null=True)
	historial_cirugias = models.CharField(max_length=256, null=True)
	historial_medicamentos = models.CharField(max_length=256, null=True)
	historial_enfermedades_familia = models.CharField(max_length=256, null=True)
	historial_enfermedades_infecciosas = models.CharField(max_length=256, null=True)
	historial_habitos_salud = models.CharField(max_length=256, null=True)
